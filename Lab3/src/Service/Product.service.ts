    ...
    protected Products: Array<Prodcut> = [
        {
            ...
            Discription: 'Постер для интерьера на стену (30х40 см). Киберпанк 2077 - Джони Сильверхенд (Cyberpunk 2077 - Johny Silverhand).Отличное украшение любого интерьера. Высокое качество печати. Порадуйте себя и удивите гостей! Или подарите близким - постеры надежно упакованы в тубус.Поставляются скрученными в плотном картонном тубусе. Рамы в комплект не входят.',
        ...
        },
        {
            ...
            Discription: 'Керамическая кружка с полноцветным глянцевым изображением, объемом 350 мл. Кружка сделана на превосходном уровне в HD качестве.',
        ...
        },
        {
            ...
            Discription: 'Крутая маска отличается от всех других аксессуаров для косплея. Полна механического и технологического смысла.',
        ...
        },
        {
            ...
            Discription: 'Кубок выполнен из керамики высокого качества и покрыт безопасной для здоровья глазурью. С легкостью выдержит горячие или холодные напитки.',
        ...
        },
        {
            ...
            Discription: 'Собрание графических романов по мотивам легендарной компьютерной игры Dark Souls! В книгу вошла вся коллекция из 4 частей',
        ...
        },
        {
            ...
            Discription:'К двадцатилетию выхода PERSONA5 Atlus и SEGA выпустили небольшой эксклюзивный артбук в Японии.',
            Tag:"Книга",
        },
        {
            Id:7,
            ...
            Discription:'Стильный и современный дизайн столиков серии Матисс-М сочетается с простотой сборки и эксплуатации, что делает их популярными в нашем ассортименте.',
            Tag:'Интерьер'
        },
        {
            Id:8,
